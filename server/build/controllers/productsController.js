...
class ProductsController {
    ...
    cons(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const object = yield database_1.default.query("SELECT p.nIdProducto,p.cDescripcion,p.nPrecio FROM productos p  WHERE p.nIdProducto = ? AND p.bActivo = true", [req.params["id"]]);
            if (object.length > 0) {
                r.data = object[0];
                r.message = "Exito";
            }
    ...
    select(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const r = new modelController_1.default();
            const object = yield database_1.default.query("SELECT p.nIdProducto,p.cDescripcion,p.nPrecio FROM productos p WHERE p.bActivo = true");
            if (object.length > 0) {
                r.data = object;
                r.message = "Exito";
            }
