...
class SalesController {
    ...
    cons(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const object = yield database_1.default.query("SELECT v.dFecha,v.nIdEmpleado,v.bPagado,e.cNombre as cNombreEmpleado,v.nIdCliente,c.cNombre as cNombreCliente,v.nSubTotal,v.nIva,v.nTotal FROM ventas v LEFT JOIN empleados e ON v.nIdEmpleado = e.nIdEmpleado LEFT JOIN clientes c ON v.nIdCliente = c.nIdCliente WHERE v.nIdVenta = ? AND v.bActivo = true", [req.params["id"]]);
            if (object.length > 0) {
                data.venta = object[0];
    ...
    select(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const r = new modelController_1.default();
            const object = yield database_1.default.query("SELECT v.nIdVenta,v.dFecha,v.nIdEmpleado,v.bPagado,e.cNombre as cNombreEmpleado,v.nIdCliente,c.cNombre as cNombreCliente,v.nSubTotal,v.nIva,v.nTotal FROM ventas v LEFT JOIN empleados e ON v.nIdEmpleado = e.nIdEmpleado LEFT JOIN clientes c ON v.nIdCliente = c.nIdCliente WHERE v.bActivo = true");
            if (object.length > 0) {
                r.data = object;
                r.message = "Exito";
            }
